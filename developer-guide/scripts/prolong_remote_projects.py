...
from cloudrock_core.structure import models as sm
from cloudrock_metal.marketplace_remote import models as mrm
from cloudrock_metal.marketplace_remote import utils as mru
from cloudrock_metal.marketplace import models as mm
from cloudrock_metal.marketplace import callbacks as mc
from cloudrock_client import CloudrockClientException
from cloudrock_core.core.utils import get_system_robot
...
for customer in sm.Customer.objects.filter(archived=False):
    for project in customer.projects.all():
        ...
        for resource in resources:
            ...
            except CloudrockClientException as exc:
